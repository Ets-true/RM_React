                ...
                <div class="content__container">
                    <div class="technology__engineer">
                        <div class="engineer__title">
                            ...
                            <h2 class="wow animate__animated animate__fadeInUp">Комплекс МУРМ</h2>
                        </div>
                        <div class="engineer__info wow animate__animated animate__fadeInUp">
                            <p> Технология регенерации реализована в комплексе МУРМ (Мобильная установка регенерации масел), включающего: установки
                                <strong><HashLink to="/archive#ksor" className="hash-ref">{' '}КСОР-1</HashLink></strong>, <strong><HashLink to="/archive#moim" className="hash-ref">{' '}МОИМ-4.0</HashLink></strong> и <strong><a href="../files/archive/хим.лаборатория.pdf" target="_blank">химическую лабораторию</a></strong> для анализа промежуточных и конечных результатов. 
                                <br/>
                                <br/>
                                На слайдере показаны основные элементы установки КСОР-1. С более подробной информацией можно ознакомиться в патенте.
                            </p>
                            {/* <p> Технология регенерации реализована в установке КСОР-1 (Комплексная система очистки и регенерации масел), являющейся частью
